...
public class ClientManager {
	...
	public static void getfromClient(String server, int port, String user, String password, String serverfile, String localfile) throws SocketException, IOException {
	...
	public static void getfromHdfs(String type, String accesskey, String secretkey, String bucketname, String key) throws IOException {
